...
Repo layout: the canonical skill lives at `plugins/rasputin/skills/rasputin-setup/SKILL.md`
(the Claude Code plugin; `.claude-plugin/marketplace.json` at the repo root makes this repo
an installable marketplace). `.agents/skills/rasputin-setup/SKILL.md` is a byte-identical
copy for Codex-style discovery — **edit both together**.
